...
describe("schemas/latlong.json", function () {
    describe("Latitude and Longitude Data", function () {
        ...
        it("should not accept a string as data", () => {
            const data = "invalid";
            const isValid = validateLatLong(data);
            expect(isValid).to.be.false;
        });
        ...
        it("should not accept a valid coordinate pair as strings", () => {
            // should reject as the schema is for numbers.
            const data = {latitude: "51.903", longitude: "-0.414"};
            const isValid = validateLatLong(data);
            expect(isValid).to.be.false;
        });

        // the data itself is an integer, not the data contained within an object
